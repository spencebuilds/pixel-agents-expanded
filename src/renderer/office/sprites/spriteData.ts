import type { Direction, FloorColor } from "../../../shared/types.ts";
import { Direction as Dir } from "../../../shared/types.ts";
...
export function getCharacterSprites(
  ...
  if (loadedCharacters) {
    ...
    const rf = (t: TemplateCell[][]) =>
      resolveTemplate(flipHorizontal(t), pal);
